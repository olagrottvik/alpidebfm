...
#------------------------------------------------------
quietly set lib_name "vip_alpide"
quietly set part_name "vip_alpide"
# path from mpf-file in sim
quietly set vip_alpide_part_path "../../../source/bench/$part_name"

if { [info exists 1] } {
  # path from this part to target part
  quietly set vip_alpide_part_path "$1"
  unset 1
}
...
if {[file exists $vip_alpide_part_path/sim/$lib_name]} {
  file delete -force $vip_alpide_part_path/sim/$lib_name
}
echo "\n\n****\n"
if {![file exists $vip_alpide_part_path/sim]} {
  file mkdir $vip_alpide_part_path/sim
}

vlib $vip_alpide_part_path/sim/$lib_name
vmap $lib_name $vip_alpide_part_path/sim/$lib_name
...
eval vcom  $compdirectives  $vip_alpide_part_path/src/alpide_bfm_pkg.vhd
